...
using NetTopologySuite.IO.PortableShape.Streams;
using System;
...
namespace NetTopologySuite.IO.PortableShape
{
    ...
    public class ShapefileDataWriter
    {
        ...
        public ShapefileDataWriter(string fileName) : this(fileName, NetTopologySuite.Geometries.GeometryFactory.Default) { }
        ...
        public ShapefileDataWriter(string fileName, IGeometryFactory geometryFactory)
            : this(fileName, geometryFactory, Encoding.UTF8)
        {
        ...
        public void Write(IList<IFeature> featureCollection)
        {
            ...
            if (Header == null)
                throw new Exception("Header must be set first!");
